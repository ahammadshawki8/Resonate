...
import 'package:resonate_server_server/src/generated/protocol.dart' as _i3;

/// Weekly analytics summary (DTO, not stored in DB).
abstract class WeeklyAnalytics
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'moodChange': moodChange,
      if (bestDay != null) 'bestDay': bestDay,
      'dailyData': dailyData.toJson(valueToJson: (v) => v.toJsonForProtocol()),
    };
  }
