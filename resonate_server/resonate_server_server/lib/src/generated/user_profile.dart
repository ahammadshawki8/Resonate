...
class UserProfileUpdateTable extends _i1.UpdateTable<UserProfileTable> {
  ...
  _i1.ColumnValue<int, int> totalCheckins(int value) => _i1.ColumnValue(
    table.totalCheckins,
    value,
  );
  ...
  _i1.ColumnValue<double, double> averageMood(double value) => _i1.ColumnValue(
    table.averageMood,
    value,
  );
}
...
class UserProfileTable extends _i1.Table<int?> {
  ...
  late final _i1.ColumnInt totalCheckins;

  late final _i1.ColumnInt currentStreak;

  late final _i1.ColumnInt longestStreak;

  late final _i1.ColumnDouble averageMood;
