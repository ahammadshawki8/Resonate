...
class HomeScreen extends ConsumerWidget {
  ...
  void _showWalkSuggestion(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final walks = [
      {
        'emoji': '🌳',
            ...
            ...walks.map((w) => Container(
                  ...
                  child: ListTile(
                    ...
                    title: Row(children: [
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                              color: (w['color'] as Color).withOpacity(0.1),
                              borderRadius: BorderRadius.circular(8.r)),
                          child: Text(w['duration'] as String,
                              style: TextStyle(
                                  fontSize: 10.sp,
                                  color: w['color'] as Color,
                                  fontWeight: FontWeight.w600))),
                    ...
                    trailing: Icon(Icons.directions_walk,
                        color: w['color'] as Color, size: 24.sp),
                    onTap: () {
                      Navigator.pop(context);
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text(
                              '${w['emoji']} Enjoy your ${w['title']}! 🚶'),
                          backgroundColor: w['color'] as Color));
                    },
                    tileColor: isDark ? AppColors.cardDark : AppColors.surface,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12.r)),
